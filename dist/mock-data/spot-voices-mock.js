...
exports.spotVoiceValid = void 0;
exports.buildSpotVoiceData = buildSpotVoiceData;
function buildSpotVoiceData(overrides = {}, attributesToRemove = []) {
    const baseData = {
...
exports.spotVoiceValid = buildSpotVoiceData();
